...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 123.0, 551.0, 54.0, 22.0 ],
					"text" : "delay 17"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 70.0, 512.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 172.0, 133.5, 32.0, 22.0 ],
									"text" : "200."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 133.5, 90.0, 22.0 ],
									"text" : "-35., -3. 28000."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 50.0, 165.5, 141.0, 22.0 ],
									"text" : "line 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 193.5, 41.0, 22.0 ],
									"text" : "set $1"
								}
...
,
					"patching_rect" : [ 365.0, 429.5, 80.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 299.5, 557.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.5, 584.0, 32.0, 22.0 ],
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 394.0, 377.5, 29.5, 22.0 ],
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 256.0, 377.5, 29.5, 22.0 ],
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 203.0, 714.0, 114.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 591.0, 145.0, 22.0 ],
					"text" : "open tryAgain.wave wave"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 123.0, 637.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 203.0, 687.0, 69.0, 22.0 ],
					"text" : "sfrecord~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 860.0, 46.5, 84.0, 23.0 ],
					"text" : "loadmess 0.05"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 710.0, 35.0, 56.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 418.0, 89.0, 14.0, 58.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 394.0, 316.0, 119.0, 23.0 ],
					"text" : "dattorroReverb~ tom"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 416.5, 624.0, 75.0, 23.0 ],
					"text" : "send~ toPlot"
				}
...
, 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "mimeophon.maxpat",
					"numinlets" : 2,
					"numoutlets" : 2,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 256.0, 89.0, 157.0, 219.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 616.0, 68.0, 88.0, 23.0 ],
					"text" : "receive~ toPlot"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 256.0, 20.0, 157.0, 23.0 ],
					"text" : "dist_noise_abstract",
					"varname" : "dist_noise"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 710.0, 68.0, 82.0, 23.0 ],
					"text" : "range -1.1 1.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 794.0, 107.0, 53.0, 23.0 ],
					"text" : "trigger 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 855.0, 101.0, 68.0, 23.0 ],
					"text" : "triglevel $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 802.0, 68.0, 53.0, 23.0 ],
					"text" : "trigger 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 860.0, 77.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 654.0, 107.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 710.0, 100.5, 62.0, 23.0 ],
					"text" : "range -2 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 649.0, 142.5, 362.0, 174.0 ],
					"range" : [ -1.1, 1.1 ],
					"trigger" : 1,
					"triglevel" : 0.05
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 365.0, 620.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 365.0, 470.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 60.0, 89.0, 128.0, 128.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 256.0, 316.0, 119.0, 23.0 ],
					"text" : "dattorroReverb~ tom"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1005.5, 339.666663999999969, 88.0, 23.0 ],
					"text" : "receive~ toPlot"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 649.0, 339.666663999999969, 88.0, 23.0 ],
					"text" : "receive~ toPlot"
				}
...
,
					"patching_rect" : [ 847.0, 366.5, 58.0, 24.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 13.0,
...
,
					"patching_rect" : [ 649.0, 366.5, 108.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 13.0,
...
, 			{
				"box" : 				{
					...
					"numpoints" : 512,
					"outlettype" : [ "" ],
					"patching_rect" : [ 649.0, 401.5, 483.0, 273.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 1005.5, 366.5, 121.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 847.0, 423.5, 50.0, 50.0 ],
					"subplots" : [ 						{
							"color" : [ 0.4, 0.4, 0.75, 1.0 ],
							"thickness" : 3.0,
							"point_style" : "circle",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 236.5, 89.0, 14.0, 58.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 132.5, 675.25, 212.5, 675.25 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 79.5, 629.5, 212.5, 629.5 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-128::obj-13" : [ "live.dial[20]", "damping", 0 ],
			"obj-128::obj-14" : [ "live.dial[18]", "predelay", 0 ],
			"obj-128::obj-2" : [ "live.dial[21]", "dry wet", 0 ],
			"obj-128::obj-6" : [ "live.dial[11]", "decay", 0 ],
			"obj-48" : [ "live.gain~[1]", "live.gain~", 0 ],
			"obj-9::obj-109" : [ "live.dial[25]", "Q", 0 ],
			"obj-9::obj-115" : [ "live.dial[3]", "skew", 0 ],
			"obj-9::obj-22" : [ "live.dial[26]", "Mix", 0 ],
			"obj-9::obj-37" : [ "live.dial[23]", "Repeats", 0 ],
			"obj-9::obj-62" : [ "live.dial[24]", "rate", 0 ],
			"obj-9::obj-70" : [ "live.dial[27]", "Freq", 0 ],
			"obj-9::obj-7::obj-115" : [ "live.dial[2]", "skew", 0 ],
			"obj-9::obj-7::obj-62" : [ "live.dial[19]", "rate", 0 ],
			"parameterbanks" : 			{
...
, 			{
				"name" : "dist_noise_abstract.maxpat",
				"bootpath" : "~/Desktop/try again v3",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
